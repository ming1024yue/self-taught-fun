...
const descriptions:Record<string,string>={
 ...
 compbio:"生物 × 计算机 × 统计",biophysics:"生物 × 物理",cogsci:"心理学 × 生物 × 计算机",behavecon:"心理学 × 经济学",neuroecon:"神经科学 × 心理学 × 经济学",compsocial:"社会科学 × 计算机 × 统计",network:"数学 × 计算机 × 自然与社会系统",econophysics:"经济学 × 统计物理",quantumcomp:"物理 × 数学 × 计算机",psychometrics:"心理学 × 统计",mathbio:"数学 × 生物",epidemiology:"生物 × 统计 × 社会科学",hci:"计算机 × 心理学 × 社会科学",compneuro:"神经科学 × 数学 × 计算机",exercise:"生物 × 生理 × 物理 × 心理 × 数据科学",nutrition:"生物 × 化学 × 心理 × 公共健康 × 运动科学",finearts:"视觉艺术 × 历史 × 文学 × 心理",design:"艺术 × 心理 × 工程 × 计算机 × 社会科学",music:"艺术 × 数学 × 声学 × 计算机 × 心理 × 历史"
};
